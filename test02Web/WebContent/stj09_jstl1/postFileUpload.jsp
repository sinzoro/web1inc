...
<script language='javascript' src="${pageContext.request.contextPath}/common/js/showModalDialogCallee.js" ></script>
...
<script language='javascript'>
        ...
        function UpdateFileInsertProSubmit() {
    		...
    		iframe.getElementById("UpdateFileInsertPro").action = "${pageContext.request.contextPath}/BoardAction09";
