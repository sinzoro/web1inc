...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/stj09_jstl1/css/style.css"
	type="text/css" />
...
<body>
	<div class="wrap">
		<form action="${pageContext.request.contextPath}/BoardAction09" name='writePageForm' id='writePageForm' method='post'  enctype="multipart/form-data">
			...
			<div class="input_wrapper">
				...
				<div class="input_wrap">
					<input type="text" id="title" name=title class="input_title" onkeyup="on_key_up(this,'${ckMap.titleLeng}')" value='a' autofocus>
					<input type="text" id="title_byteCheck" class="" name="title_byteCheck" value="(0/${ckMap.titleLeng})" readonly>
				</div>
			</div>
			<div class="input_wrapper">
				<div class="title_wrap">
				...
				<div class="input_wrap">
					<input type="text" id="name" name=name onkeyup="on_key_up(this,'${ckMap.writerLeng}')" value='a' autofocus>
					&nbsp;<input type="text" id="name_byteCheck" class="name_byteCheck" name="name_byteCheck" value="(0/${ckMap.titleLeng})" readonly>
			...
			<div class="cont_wrapper">
				...
				<textarea name="content" rows="10" cols="100" placeholder="내용입력"
					title="내용입력" id="content" name="content" onkeyup="on_key_up(this,'${ckMap.contentLeng}')" >a</textarea>
				<input type="text" id="content_byteCheck" class="content_byteCheck" name="content_byteCheck" value="(0/${ckMap.titleLeng})" readonly>
			</div>
			<div class="cont_wrapper">
				<div class="title_wrap">
