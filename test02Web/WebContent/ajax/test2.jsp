...
<script language="javascript">
	...
	function loadAjax() {
		var sendData;
		//sendData = $("form").serialize();//2
		sendData = $("form").serializeArray();
		//console.log("sendData:"+sendData);//2
		
		console.log("sendData:"+JSON.stringify(sendData));
		console.log(sendData[0]["name"] +" = "+ sendData[0]["value"] );
...
<body>
	...
	<form>
		...
		<p>
		<div id="disp"><div id="disp"><div id="disp">111</div>111</div>111</div>
