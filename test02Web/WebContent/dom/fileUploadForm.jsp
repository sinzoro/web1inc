...
<input type="hidden" name="fileNameCount" value="3" >
<input type="hidden" name="fileNameArr" value="0:1:" >
<table>
	<tr>
	...
	<tr>
		<td><label for = "fileName1">파일명1 : </label></td><td><input type="file" name="fileName1" id = "fileName1" value="null"></td>
	</tr>
	<tr>
		<td><label for = "fileName2">파일명2 : </label></td><td><input type="file" name="fileName2" id = "fileName2"></td>
	</tr>
	<tr>
		<td><label for = "fileName2">파일명3 : </label></td><td><input type="file" name="fileName3" id = "fileName3"></td>
	</tr>
	<tr>
