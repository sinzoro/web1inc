...
<body>
	<form name="filecheck" action="fileCheck.jsp" method="post">
		<input type="text" name="name" value="<%=name%>"> <input
			...
			type="text" name="filename1"
			value="<%=(filename[0]==null?"":filename[0])%>"> <<%-- input
		type="text" name="filename2"
		value="<%=(filename[1]==null?"":filename[1])%>"> <input type="text"
		name="filename3" value="<%=(filename[2]==null?"":filename[2])%>"> --%>
		<input type="text" name="origfilename1"
		value="<%=(origfilename[0]==null?"":origfilename[0])%>"> <%-- <input
		type="text" name="origfilename2"
		value="<%=(origfilename[1]==null?"":origfilename[1])%>"> <input
		type="text" name="origfilename3"
		value="<%=(origfilename[2]==null?"":origfilename[2])%>"> --%> </form>
		<a href="#" onclick="javascript:filecheck.submit()">업로드 확인 및 다운로드 페이지
		이동</a> </body> </html>