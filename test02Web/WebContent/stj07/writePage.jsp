		...
		<form action="<%=request.getContextPath()%>/BoardAction" name='writePageForm' id='writePageForm' method='post'  enctype="multipart/form-data">
			...
			<div class="input_wrapper">
				...
				<div class="input_wrap">
					<input type="text" id="title" name=title class="input_title" onkeyup="on_key_up(this,'<%=ckMap.get("titleLeng")%>')" value='a' autofocus>
			...
			<div class="input_wrapper">
				...
				<div class="input_wrap">
					<input type="text" id="name" name=name onkeyup="on_key_up(this,'<%=ckMap.get("writerLeng")%>')" value='a' autofocus>
			...
			<div class="cont_wrapper">
				...
				<textarea name="content" rows="10" cols="100" placeholder="내용입력"
					title="내용입력" id="content" name="content" onkeyup="on_key_up(this,'<%=ckMap.get("contentLeng")%>')" >a</textarea>
