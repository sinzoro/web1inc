...
<script language='javascript'>
	...
	function boardInsertSubmit(){
		...
		document.getElementById('form3').action = '<%=request.getContextPath()%>/BoardAction';
...
<body>
	...
	<form id="form3" name="form3" action="<%=request.getContextPath()%>/BoardAction" method='post'>
		...
		<div class="wrap">
		    ...
		    <table>
		        ...
		        <tbody>
		            ...
		            <tr>
		            	<td><%=((BoardEntity)bList.get(i)).getBoardNum() %></td>
		                <td><%=((BoardEntity)bList.get(i)).getBoardTitle() %></td>
		                <th scope="row">
		                	<a href="javascript:boardDetailSubmit('<%=((BoardEntity)bList.get(i)).getBoardNum() %>')"><%=((BoardEntity)bList.get(i)).getBoardContent() %></a>
		                </th>
		                <td><%=((BoardEntity)bList.get(i)).getCreateDate() %></td>
		                <td><%=((BoardEntity)bList.get(i)).getBoardClickCnt() %></td>
		            </tr>
		            <% } %>
