 ...
 */
public class PagingListRst3 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PagingListRst3() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//출력 테이블
				if( allCount <= 0 ) {
					...
					out.write("<form action=PagingListRst3 method='post'>");
						...
						out.write("<td colspan='2' align=center >");
							...
							out.write("<tr>");
								...
								if( sels >= 1 ) {
									out.write( "<td><a href='/test02Web/PagingListRst3?allCount="+allCount+"&pageContentCount="+pageContentCount
						...
						out.write("<tr>");
							out.write("<td colspan=3>");
								out.write("<input type='text' name='selectPageNum' >");
								out.write("<input type='submit' value='test' >");
							out.write("</td>");
						out.write("</tr>");
						out.write("</table>");
						
						out.write("<input type='hidden' name='allCount' value="+allCount+">");
						out.write("<input type='hidden' name='pageContentCount' value="+pageContentCount+">");
						out.write("<input type='hidden' name='pageViewMaxCount' value="+pageViewMaxCount+">");
					out.write("</form>");
				}
