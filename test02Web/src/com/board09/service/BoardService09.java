...
public class BoardService09 {
	...
	public BoardService09() {
		this.viewPage = 1;
		this.maxPagingViewCount = 2;
		this.viewCount = 2;
	}

	public BoardService09(HashMap<String, String> selectMap) {
		this();
	...
	BoardDao09 boardDao = new BoardDao09();
	ArrayList<BoardEntity09> boardList = new ArrayList<BoardEntity09>();

	public ArrayList<BoardEntity09> getList() {
	...
	public void FileSave( MultipartRequest multi, String uploadPath, String setNum ) {
		...
		for (int i = 0; i < Integer.parseInt(selFileCKCount); i++) {
			...
			if( !origfilename[i].equals("null") ) {
				...
				boardFileEntity = new BoardFileEntity09();
	...
	public int setBoardFileUpload( ArrayList<BoardFileEntity09> flist ) throws Exception {
